...
# all_files = glob(root_dir + 'Build_WRF/models/real/run/met_em*')
...
def plot_all_vars(dataset: Dataset) -> None:
    ...
    _, axes = plt.subplots(math.ceil(len_vars / cols_num), cols_num, figsize=(12, 11))
    idx: int = 0
...
for input_name in all_files:
    ...
    output_name: str = root_dir + 'modified-files/met_em/' + file_name
