# This is to modify the boundary condition file of a WRF run (wrfbdy), the files are expected to be created from the modified version of met_em file of WPS
