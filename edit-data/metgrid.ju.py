# This is to modified met_em file of WPS, the files are expected to be generated from the modified version of geo_em file
...
root_dir = '/homeguc/'
all_files = glob(root_dir + 'wps/met_em*')
