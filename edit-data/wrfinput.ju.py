# This is to modify the initial condition file of a WRF run (wrfinput), the files are expected to be created from the modified version of met_em file of WPS
